...
import (
	...
	cfg "github.com/snappyflow/beats/v7/filebeat/config"
	"github.com/snappyflow/beats/v7/filebeat/fileset"
	_ "github.com/snappyflow/beats/v7/filebeat/include"
	"github.com/snappyflow/beats/v7/filebeat/input"
	v2 "github.com/snappyflow/beats/v7/filebeat/input/v2"
	"github.com/snappyflow/beats/v7/filebeat/input/v2/compat"
	"github.com/snappyflow/beats/v7/filebeat/registrar"
	"github.com/snappyflow/beats/v7/libbeat/autodiscover"
	...
	"github.com/snappyflow/beats/v7/libbeat/common/cfgwarn"
	"github.com/snappyflow/beats/v7/libbeat/common/reload"
	"github.com/snappyflow/beats/v7/libbeat/esleg/eslegclient"
	"github.com/snappyflow/beats/v7/libbeat/logp"
	"github.com/snappyflow/beats/v7/libbeat/management"
	"github.com/snappyflow/beats/v7/libbeat/monitoring"
	"github.com/snappyflow/beats/v7/libbeat/outputs/elasticsearch"
	"github.com/snappyflow/beats/v7/libbeat/publisher/pipetool"
	"github.com/snappyflow/beats/v7/libbeat/statestore"
	"github.com/elastic/go-concert/unison"

	_ "github.com/snappyflow/beats/v7/filebeat/include"

	// Add filebeat level processors
	_ "github.com/snappyflow/beats/v7/filebeat/processor/add_kubernetes_metadata"
	_ "github.com/snappyflow/beats/v7/libbeat/processors/decode_csv_fields"

	// include all filebeat specific builders
	_ "github.com/snappyflow/beats/v7/filebeat/autodiscover/builder/hints"
)
