...
import (
	...
	"github.com/snappyflow/beats/v7/heartbeat/beater"

	// include all heartbeat specific autodiscovery builders
	_ "github.com/snappyflow/beats/v7/heartbeat/autodiscover/builder/hints"

	// register default heartbeat monitors
	_ "github.com/snappyflow/beats/v7/heartbeat/monitors/defaults"
