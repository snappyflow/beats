...
import (
	...
	metricbeat "github.com/snappyflow/beats/v7/metricbeat/scripts/mage"

	// register kubernetes runner
	_ "github.com/snappyflow/beats/v7/dev-tools/mage/kubernetes"

	// mage:import
	"github.com/snappyflow/beats/v7/dev-tools/mage/target/build"
	// mage:import
	"github.com/snappyflow/beats/v7/dev-tools/mage/target/common"
	// mage:import
	_ "github.com/snappyflow/beats/v7/dev-tools/mage/target/dashboards"
	// mage:import
	_ "github.com/snappyflow/beats/v7/dev-tools/mage/target/docs"
	// mage:import
	_ "github.com/snappyflow/beats/v7/dev-tools/mage/target/pkg"
	// mage:import
	"github.com/snappyflow/beats/v7/dev-tools/mage/target/test"
	// mage:import
	"github.com/snappyflow/beats/v7/dev-tools/mage/target/unittest"
	// mage:import
	_ "github.com/snappyflow/beats/v7/dev-tools/mage/target/compose"
	// mage:import
	_ "github.com/snappyflow/beats/v7/metricbeat/scripts/mage/target/metricset"
)
...
func MockedTests(ctx context.Context) error {
	...
	params.ExtraFlags = []string{"github.com/snappyflow/beats/v7/metricbeat/mb/testing/data/."}
