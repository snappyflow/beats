...
import (
	...
	_ "github.com/snappyflow/beats/v7/metricbeat/autodiscover/builder/hints"

	// include all metricbeat specific appenders
	_ "github.com/snappyflow/beats/v7/metricbeat/autodiscover/appender/kubernetes/token"

	// Add metricbeat default processors
	_ "github.com/snappyflow/beats/v7/metricbeat/processor/add_kubernetes_metadata"
)
