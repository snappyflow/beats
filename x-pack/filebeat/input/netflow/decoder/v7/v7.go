...
import (
	...
	"github.com/snappyflow/beats/v7/x-pack/filebeat/input/netflow/decoder/config"
	"github.com/snappyflow/beats/v7/x-pack/filebeat/input/netflow/decoder/fields"
	"github.com/snappyflow/beats/v7/x-pack/filebeat/input/netflow/decoder/protocol"
	"github.com/snappyflow/beats/v7/x-pack/filebeat/input/netflow/decoder/record"
	"github.com/snappyflow/beats/v7/x-pack/filebeat/input/netflow/decoder/template"
	v1 "github.com/snappyflow/beats/v7/x-pack/filebeat/input/netflow/decoder/v1"
)
