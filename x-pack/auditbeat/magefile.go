...
import (
	...
	auditbeat "github.com/snappyflow/beats/v7/auditbeat/scripts/mage"
	...
	// mage:import
	_ "github.com/snappyflow/beats/v7/dev-tools/mage/target/integtest"
	// mage:import
...
func installDependencies(pkg, arch string) error {
	...
	// See https://github.com/snappyflow/beats/v7/issues/11750 for more details.
