...
import (
	...
	"github.com/snappyflow/beats/v7/x-pack/elastic-agent/pkg/artifact/install/dir"

	"github.com/snappyflow/beats/v7/x-pack/elastic-agent/pkg/artifact"
	"github.com/snappyflow/beats/v7/x-pack/elastic-agent/pkg/artifact/install/hooks"
	"github.com/snappyflow/beats/v7/x-pack/elastic-agent/pkg/artifact/install/tar"
	"github.com/snappyflow/beats/v7/x-pack/elastic-agent/pkg/artifact/install/zip"
)
