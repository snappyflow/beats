...
import (
	...
	monitoringConfig "github.com/snappyflow/beats/v7/x-pack/elastic-agent/pkg/core/monitoring/config"
	"github.com/snappyflow/beats/v7/x-pack/elastic-agent/pkg/core/process"
	"github.com/snappyflow/beats/v7/x-pack/elastic-agent/pkg/core/retry"
