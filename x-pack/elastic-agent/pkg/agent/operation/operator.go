...
import (
	...
	"github.com/snappyflow/beats/v7/x-pack/elastic-agent/pkg/core/plugin/process"
	"github.com/snappyflow/beats/v7/x-pack/elastic-agent/pkg/core/plugin/service"
