...
import (
	...
	"github.com/snappyflow/beats/v7/x-pack/elastic-agent/pkg/agent/internal/yamltest"
	"github.com/snappyflow/beats/v7/x-pack/elastic-agent/pkg/agent/transpiler"
