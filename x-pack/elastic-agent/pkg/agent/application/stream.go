...
import (
	...
	"github.com/snappyflow/beats/v7/x-pack/elastic-agent/pkg/agent/stateresolver"
	downloader "github.com/snappyflow/beats/v7/x-pack/elastic-agent/pkg/artifact/download/localremote"
	"github.com/snappyflow/beats/v7/x-pack/elastic-agent/pkg/artifact/install"
	"github.com/snappyflow/beats/v7/x-pack/elastic-agent/pkg/artifact/uninstall"
