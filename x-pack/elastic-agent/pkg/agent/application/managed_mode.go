...
import (
	...
	"github.com/snappyflow/beats/v7/x-pack/elastic-agent/pkg/agent/application/filters"
	"github.com/snappyflow/beats/v7/x-pack/elastic-agent/pkg/agent/application/info"
	...
	"github.com/snappyflow/beats/v7/x-pack/elastic-agent/pkg/agent/operation"
	"github.com/snappyflow/beats/v7/x-pack/elastic-agent/pkg/agent/storage"
	"github.com/snappyflow/beats/v7/x-pack/elastic-agent/pkg/config"
	...
	"github.com/snappyflow/beats/v7/x-pack/elastic-agent/pkg/fleetapi"
	reporting "github.com/snappyflow/beats/v7/x-pack/elastic-agent/pkg/reporter"
	fleetreporter "github.com/snappyflow/beats/v7/x-pack/elastic-agent/pkg/reporter/fleet"
	logreporter "github.com/snappyflow/beats/v7/x-pack/elastic-agent/pkg/reporter/log"
)
