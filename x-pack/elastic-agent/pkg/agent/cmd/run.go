...
import (
	...
	"github.com/snappyflow/beats/v7/x-pack/elastic-agent/pkg/agent/application/reexec"
	"github.com/snappyflow/beats/v7/x-pack/elastic-agent/pkg/agent/configuration"
	"github.com/snappyflow/beats/v7/x-pack/elastic-agent/pkg/agent/control/server"
