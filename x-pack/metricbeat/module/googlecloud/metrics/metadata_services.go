...
import (
	"github.com/snappyflow/beats/v7/x-pack/metricbeat/module/googlecloud"
	"github.com/snappyflow/beats/v7/x-pack/metricbeat/module/googlecloud/metrics/compute"
)
